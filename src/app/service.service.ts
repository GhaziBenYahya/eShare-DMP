...
export class ServiceService {
  ...
  getdocteur(){
    return this.http.get(this.url+'Profile/GetAllProfileD')
  
   }
   getinfirmier(){
    return this.http.get(this.url+'Profile/GetAllProfileI')
  
   }
   getpharmacien(){
    return this.http.get(this.url+'Profile/GetAllProfileP')
  ...
  validerp (pat:FicheTriageForCreationDto){
   ...
   supprimerp(pat,iD_Patient ){
    return this.http.put(this.url+'Patient/Update/'+iD_Patient,pat) 
   }
